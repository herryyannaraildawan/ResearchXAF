...
namespace ResearchXAF.Module.BusinessObjects.Transaction
{
    ...
    public class HarvestingDetail : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public HarvestingDetail(Session session)
            : base(session)
        {
        }
        ...
        [Persistent("HarvestingOid"), RuleRequiredField(DefaultContexts.Save)]
        public Harvesting Harvesting
        {
            get { return _Harvesting; }
            set { SetPropertyValue(nameof(Harvesting), ref _Harvesting, value); }
        }
